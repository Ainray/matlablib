% function [w]=dft_blackman(N,mode)
% author: Ainray
% date: v1,20160308
% version: 1.0
% bug-report: wwzhang0421@163.com
% introduction: calculating the blackman window
%               w=0.42+0.5*cos(a1*cos(2*pi/N*n)+0.08*cos(4*pi/N*n),n=-(N-1)/2:(N-1)/2
%               Examples:
%                 w=dft_blackman(10), return 11 samples of sysmmtric window
%                 w=dft_blackman(10,'one-side'), return 10 samples window,
...
L=3; % blackman family window factor
a=[0.42,0.5,0.08]; % classical  blackman window
