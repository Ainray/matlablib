function [hin1, hin2, hout] = em_rmdipole_homo_fre_em_xyz(coords, freqs, direction, theta, sigma, epsilon, mu, m)
% author: Ainray
% date: 20230526
...
[hl1, ht11, ht12] = em_mdipole_homo_fre_em_xyz(coords, freqs, direction1, sigma, epsilon, mu, m);
[hl2, ht21, ht22] = em_mdipole_homo_fre_em_xyz(coords, freqs, direction2, sigma, epsilon, mu, m);
