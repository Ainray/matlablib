...
%          the output time sample rate. If you know your data is oversampled in time, consider
%          making this 2*dt (dt is your time sample rate) or greater to reduce output volume. Just
%          make sure the new Nyquist (i.e. .5/tinc) is greater than your maximum signal frequency.
...
for k=1:ntraces
    ...
    if(k==1)
        %first Gabor transform and then allocate arrays
    ...
    if(isempty(df))
        ...
        %resample in frequency by simple interpolation
