...
% *********** default 'discard' ***********
% 'kseq' ... this is the 2D array returned by make3Dvol. Supplying
%           this will automatically set 'zerotraces' to 'keep'. This
%           variable determines the ordering of the output dataset. If
    ...
    switch name
        ...
        case 'kseq'
            ...
            if((size(val,1)~=nx) || (size(val,2)~=ny))
                error('kseq has incorrect dimensions')
            end
            kseq=val;
