function [hx, hy, hz, h] = em_mdipole_h_halfspace_freq_em_xyz(sigma, x, y,freqs)
% author: Ainray
% date: 20230526
...
for i = 1:np
    ...
    hx(:,i) = -1/4/pi/ri^3 * ( yi * yi * PHI(:,i) + xi * xi * ri * PHId(:,i));
    hy(:, i) = 1/4/pi/ri^3 * ( xi * yi * PHI(:,i) - xi * yi *ri * PHId(:,i));   
    hz(:,i) = k2/4/pi*xi/ri^2 .* (besseli(1, ikr2) .* besselk(1, ikr2) - besseli(2, ikr2) .* besselk(2,ikr2));
end
